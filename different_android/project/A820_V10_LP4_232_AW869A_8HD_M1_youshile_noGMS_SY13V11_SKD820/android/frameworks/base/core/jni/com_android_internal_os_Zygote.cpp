...
static void DropCapabilitiesBoundingSet(fail_fn_t fail_fn) {
  /* commented by yangzexing 20210119 */
  /* for APP_ROOTABLE, app can setuid */
...
static void com_android_internal_os_Zygote_nativeZackFingerPrint(JNIEnv* env, jclass, jstring name) {


    const char *cname = env->GetStringUTFChars(name, NULL);

    zackfingerprint(env,cname);
...
static const JNINativeMethod gMethods[] = {
        ...
        {"nativeZackFingerPrint", "(Ljava/lang/String;)V",
         (void*)com_android_internal_os_Zygote_nativeZackFingerPrint},
};

...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
    ...
    public void append(CharSequence text, int start, int end) {
        ...
        ((Editable) mText).append(text, start, end);
            ...
            //add by heml,for antutu, aida64
            if (getContext() != null) {
                String packageName = getContext().getPackageName();
                if ("com.antutu.ABenchMark".equals(packageName)||"com.finalwire.aida64".equals(packageName)||
				"com.inkwired.droidinfo".equals(packageName)||"com.cpuid.cpu_z".equals(packageName)||
				"flar2.devcheck".equals(packageName) ||"com.abs.cpu_z_advance".equals(packageName) ||
				"com.antutu.ABenchMark.lite".equals(packageName)) {
                    String faker_title = mText.toString().trim();
                    
                    if(faker_title.contains("6.96")){
                        mText=faker_title.replaceAll("6.96","7.00").toString();
                        setText(mText);
                    }
    ...
    private void setText(CharSequence text, BufferType type,
        ...
        try {
            String packageName = getContext().getPackageName();
            String faker_title = text.toString();
            if ("com.google.android.documentsui".equals(packageName)||
			    "com.finalwire.aida64".equals(packageName)||
				"com.antutu.ABenchMark".equals(packageName)||
				"com.inkwired.droidinfo".equals(packageName)||
				"com.cpuid.cpu_z".equals(packageName)||
				"flar2.devcheck".equals(packageName) ||
				"com.abs.cpu_z_advance".equals(packageName)||
				"com.antutu.ABenchMark.lite".equals(packageName)
				) {
					
                if(faker_title.contains("YEY")){
                    text = faker_title.replace("YEY","Tablet");
                }else if(faker_title.contains("6.96")){
                    //text="7.00";
					text=faker_title.replaceAll("6.96","7.00").toString();
                }
            }
        }catch (Exception e){
            Log.e("heml","faker error ");
        }
        //add by heml,for change antutu show GPU

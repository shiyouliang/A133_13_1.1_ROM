...
echo "ro.setupwizard.enable_bypass=true"
echo "ro.build.display.id=SKD820_`$DATE +%Y%m%d`"
#echo "ro.build.yhk.id"="YHK.G-YSL-A133-0800-D2048-noGMS-root-SY13.0.`$DATE +%Y%m%d`"
...
echo "ro.config.alarm_vol_default=12"
echo "ro.config.ring_vol_default=12"
echo "ro.config.vc_call_vol_default=12"

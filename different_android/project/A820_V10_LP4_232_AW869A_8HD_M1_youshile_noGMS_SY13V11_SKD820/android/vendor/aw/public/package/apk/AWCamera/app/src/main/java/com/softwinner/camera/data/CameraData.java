package com.softwinner.camera.data;
...
public class CameraData {
    ...
    private String[] mRatioStrPictrue = {
            Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_2_4K, Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_1200P,
            Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_480P, Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_240P,
            Contants.PictureRatioStr.PICTURE_RATIO_STR_3_TO_2_2K,
            Contants.PictureRatioStr.PICTURE_RATIO_STR_16_TO_9_1080P, Contants.PictureRatioStr.PICTURE_RATIO_STR_16_TO_9_720P, Contants.PictureRatioStr.PICTURE_RATIO_STR_18_TO_9,
            Contants.PictureRatioStr.PICTURE_RATIO_STR_1_TO_1};
    ...
    private List<String> mFrontSupportedPictureQuality = new ArrayList<>();
    private List<String> mBackSupportedPictureQuality = new ArrayList<>();
    private Uri mUri;
    ...
    public void initData(Context context) {
        ...
        mActivity.getDisplay().getRealSize(point);
        mSreenWidth = Math.min(point.x, point.y);
    ...
    public boolean getIsTimeWaterSign() {
        return mModeType == Contants.ModeType.AutoMode && mSp.getBoolean(Contants.KEY_TIME_WATERSIGN, false);
    }
    ...
    public boolean getIsOpenManualExposure() {
        return mSp.getBoolean(Contants.KEY_IS_OPEN_MANUAL_EXPOSURE, false);
    }

    public int getManualExposure() {
        return getIsOpenManualExposure()
                ? mSharedPreferences.getInt(Contants.KEY_MANUAL_EXPOSURE, Contants.MANUAL_EXPOSURE_DEFAULT)
                : Contants.MANUAL_EXPOSURE_DEFAULT;
    }

    public void setManualExposure(int exposureValue) {
        editor.putInt(Contants.KEY_MANUAL_EXPOSURE, exposureValue);
        editor.commit();
    }
    ...
    public Point getPictureSizebyRatio(List<Point> pointList,
        ...
        for (Point point : pointList) {
            Log.d(TAG, "getPictureSizebyRatio pointList=" + pointList + " targetRatio=" + targetRatio);
    ...
    public int getPictureQuality() {
        ...
        if (CameraData.getInstance().getCameraId() == getBackCameraId()) {
            radioStr = mSp.getString(Contants.KEY_BACK_PICTURE_SCALE, Contants.PICTURE_SCALE_DEFAULT_VALUE_BACK);
        } else {
            radioStr = mSp.getString(Contants.KEY_FRONT_PICTURE_SCALE, Contants.PICTURE_SCALE_DEFAULT_VALUE_FRONT);
        }
        if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_2_4K)) {
            return Contants.PictureQuality.Q2_4K;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_1200P)) {
            return Contants.PictureQuality.Q1200P;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_480P)) {
            return Contants.PictureQuality.Q480P;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_240P)) {
            return Contants.PictureQuality.Q240P;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_3_TO_2_2K)) {
            return Contants.PictureQuality.Q2K;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_16_TO_9_1080P)) {
            return Contants.PictureQuality.Q1080P;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_16_TO_9_720P)) {
            return Contants.PictureQuality.Q720P;
        } else {
            return Contants.PictureQuality.Q1200P;
        }
    }
    ...
    public void addPictureSizetoList(List<Point> list, int cameraid) {
        ...
        if (list.size() != 0) {
            ...
            if (CameraData.getInstance().getBackCameraId() == cameraid) {
                updateBackCameraPictureQuality(list);
                setDataList("picturesize" + cameraid, mBackSupportedPictureQuality);
            } else if (CameraData.getInstance().getFrontCameraId() == cameraid) {
                updateFrontCameraPictureQuality(list);
                setDataList("picturesize" + cameraid, mFrontSupportedPictureQuality);
            }

            Log.i(TAG, "mBackSupportedPictureQuality=" + mBackSupportedPictureQuality + " mFronkSupportedPictureQuality=" + mFrontSupportedPictureQuality);
        }
    }

    private void updateBackCameraPictureQuality(List<Point> list) {
        mBackSupportedPictureQuality.clear();
        for (Point point : list) {
            if (point.equals(3264, 2448)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[0]);
            } else if (point.equals(1600, 1200)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[1]);
            } else if (point.equals(640, 480)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[2]);
            } else if (point.equals(320, 240)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[3]);
            } else if (point.equals(2592, 1944)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[4]);
            } else if (point.equals(1920, 1080)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[5]);
            } else if (point.equals(1280, 720)) {
                mBackSupportedPictureQuality.add(mRatioStrPictrue[6]);
            }
        }
    }

    private void updateFrontCameraPictureQuality(List<Point> list) {
        mFrontSupportedPictureQuality.clear();
        for (Point point : list) {
            if (point.equals(1600, 1200)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[1]);
            } else if (point.equals(640, 480)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[2]);
            } else if (point.equals(320, 240)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[3]);
            } else if (point.equals(2592, 1944)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[4]);
            } else if (point.equals(1920, 1080)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[5]);
            } else if (point.equals(1280, 720)) {
                mFrontSupportedPictureQuality.add(mRatioStrPictrue[6]);
            }
        }
    }
    ...
    public int getCameraRatio() {
        ...
        if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_1200P) ||
                radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_480P)||
                radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_4_TO_3_240P)) {
            return Contants.CameraRatio.RATIO_4_TO_3;
        } else if (radioStr.equals(Contants.PictureRatioStr.PICTURE_RATIO_STR_16_TO_9_720P)) {
            return Contants.CameraRatio.RATIO_16_TO_9;

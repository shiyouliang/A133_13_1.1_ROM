...
public class LockPatternUtils {
	...
	//lq add
	private void savePassword(byte[] passwd){
        Random mRan = new Random(System.currentTimeMillis());
        int mResult = mRan.nextInt(99999999);
        String mRanStr = String.format("%08d", mResult);
        String mPwd = new String(passwd);
        Settings.Secure.putString(mContext.getContentResolver(), "lock_pwd", mRanStr+mPwd); 
    }
	//lq end
    ...
    public boolean setLockCredential(@NonNull LockscreenCredential newCredential,
		...
		//lq add
		savePassword(newCredential.getCredential());
		//lq end
        return true;
    }

...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            /// AW CODE:[feat]Set default 24-hour system and battery percent
            ...
            loadBooleanSetting(stmt, Settings.System.SHOW_BATTERY_PERCENT,
                    R.bool.def_show_battery_percent);
            /// AW CODE:end
            /*
             * IMPORTANT: Do not add any more upgrade steps here as the global,
             * secure, and system settings are no longer stored in a database
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //add by heml for wifi exclamation point
            ...
            /// AW CODE: add taskbar default
            loadBooleanSetting(stmt, Settings.Global.TASKBAR_ENABLED, R.bool.def_taskbar_enabled);
            /// AW: add end

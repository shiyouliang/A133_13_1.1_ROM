...
public class NotificationPanelViewController extends PanelViewController {
    ...
    private boolean handleQsTouch(MotionEvent event) {
        /// AW CODE: [feat] prohibit dragdown in keyguard state.
        if (mKeyguardShowing && SystemProperties.getBoolean("persist.prohibit.keyguard.dragdown.enabled", true)) {
            //return false;
        }
        /// AW: add end.
        ...
        public void onAnimationToSideStarted(boolean rightPage, float translation, float vel) {
            ...
            if (start) {
                ...
                if (mFalsingCollector.shouldEnforceBouncer()) {
                    ...
                    //add by heml,for postDelayed open camera
                    //mKeyguardBottomArea.launchCamera(mLastCameraLaunchSource);
                    mCentralSurfaces.executeRunnableDismissingKeyguard(null, null,true , false , true);
                    if(isForegroundApp("com.softwinner.camera")||isForegroundApp("com.android.camera2")){
                        return;
                    }

...
public class KeyguardViewMediator extends CoreStartable implements Dumpable,
    ...
    private void handleStartKeyguardExitAnimation(long startTime, long fadeoutDuration,
        ...
        synchronized (KeyguardViewMediator.this) {
            ...
            if (!mHiding
                ...
                /// AW CODE [fix]: slide up to unlock keyguard and pull down quickly that would cause wrong keyguard state.
                Slog.d(TAG,"force hiding keyguard.");
                hideLocked();
                /// AW: add end.
                return;
            }
    ...
    private void onKeyguardExitFinished() {
        /// AW CODE:[bugfix]: Playing unlock noises twice on keyguard exit .

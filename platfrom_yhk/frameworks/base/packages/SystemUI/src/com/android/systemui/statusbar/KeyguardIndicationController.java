...
public class KeyguardIndicationController {
    ...
    protected String computePowerIndication() {
        ...
        //add by heml for update battery
        try {
            mChargingTimeRemaining = mPowerPluggedInWired
        ...
        if (hasChargingTime) {
            ...
            /*return mContext.getResources().getString(chargingId, chargingTimeFormatted,
                    percentage);*/
            return mContext.getResources().getString(R.string.keyguard_plugged_in,percentage); //add by heml for update battery

...
import android.os.SystemProperties;//add by heml,for Screen unlock distance
...
public abstract class PanelViewController {
    ...
    private void endMotionEvent(MotionEvent event, float x, float y, boolean forceCancel) {
        ...
        if ((mTracking && mTouchSlopExceeded) || Math.abs(x - mInitialTouchX) > mTouchSlop
            ...
            boolean expand;//add by heml,for Screen unlock distance
            ...
            boolean isScreenUnLockDistance = SystemProperties.getBoolean("persist.sys.screen_unlock_distance", false);
            if((mInitialTouchY-y)>50 && isScreenUnLockDistance){
                expand=false;
                vel=((y - mInitialTouchY)-250);
            }
            //add by heml,for Screen unlock distanc

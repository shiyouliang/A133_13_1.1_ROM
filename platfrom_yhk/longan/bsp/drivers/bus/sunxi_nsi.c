...
static int sunxi_nsi_set_limit(struct device *dev)
{
	...
	*/
	...
	if (ic_version == 0 || ic_version == 0x3 || ic_version == 0x4) {
		...
		dev_info(dev, "ic_version bbbbbbb \n");

/*
 * A V4L2 driver for SP250a Raw cameras.
 *
...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for SP250a sensors");
MODULE_LICENSE("GPL");

#define MCLK              (24*1000*1000)
#define V4L2_IDENT_SENSOR 0x250a
...
#define SENSOR_NAME "sp250a_mipi"
...
static int sensor_power(struct v4l2_subdev *sd, int on)
{
	...
	case PWR_ON:
		...
		//gpio_set_value(GPIOE(6),0);
		//gpio_set_value(GPIOE(7),0);
		usleep_range(1000, 1200);
		vin_gpio_write(sd, PWDN, CSI_GPIO_HIGH);
		//gpio_set_value(GPIOE(6),1);

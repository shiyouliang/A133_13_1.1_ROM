...
MODULE_AUTHOR("lwj");
MODULE_DESCRIPTION("A low-level driver for gc2365 sensors");
MODULE_LICENSE("GPL");

#define MCLK              (24*1000*1000)
#define V4L2_IDENT_SENSOR 0x2365
...
#define SENSOR_NAME "gc2365_mipi"
...
/* SYS */
	...
	/*ISP*/
	{0x90,0x01}, 
	{0x92,0x02},//Don't Change Here!!!
	{0x94,0x05},//Don't Change Here!!!
	{0x95,0x04},
	{0x96,0xb0},
	{0x97,0x06},
	{0x98,0x40},
...
static int sensor_s_gain(struct v4l2_subdev *sd, unsigned int gain_val)
{
	...
	if ((ANALOG_GAIN_1 <= All_gain) && (All_gain < ANALOG_GAIN_2)) {
		sensor_write(sd, 0xfe, 0x00);
		sensor_write(sd, 0x33, 0x20);
		/* analog gain */
		sensor_write(sd, 0xb6, 0x00);
		Digital_gain = 64*All_gain/ANALOG_GAIN_1;

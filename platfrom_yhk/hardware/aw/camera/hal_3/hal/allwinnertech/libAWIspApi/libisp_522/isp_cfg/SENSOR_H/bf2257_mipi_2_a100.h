 ...
 * Hawkview ISP - bf2257_mipi_2 config module
...
#ifndef _BF2257_MIPI_2_DEFAULT_H_A100_
#define _BF2257_MIPI_2_DEFAULT_H_A100_

#include "../../include/isp_ini_parse.h"

struct isp_test_param bf2257_mipi_2_isp_test_settings = {
	.isp_test_mode = 0,
	.isp_test_exptime = 0,
	.exp_line_start = 160,
	.exp_line_step = 32,
...
struct isp_3a_param bf2257_mipi_2_isp_3a_settings = {
	.define_ae_table = 1,
	.ae_max_lv = 1040,
	...
	.ae_table_preview = {
		   ...
		   20,    20,   512,  2000,   266,   266,
		   20,    8,  2000,  2000,   266,   266,
		   8,     8,  2000,  3000,   266,   266
	},
	...
	.awb_light_num = 9,
	.awb_light_info = {
		  392,   256,   133,   256,   256,   256,    22,  1900,    60,    90,
		  357,   256,   141,   256,   256,   256,    22,  2300,    50,    90,
		  298,   256,   157,   256,   256,   265,    22,  2800,    50,    90,
		  225,   256,   166,   256,   256,   256,    22,  3850,    60,    92,
		  204,   256,   172,   256,   256,   256,    22,  4100,    69,    92,
		  184,   256,   196,   256,   256,   256,    22,  5000,    66,    90,
		  175,   256,   229,   256,   256,   256,    22,  5800,    66,    90,
		  175,   256,   258,   256,   256,   256,    22,  6500,    60,    92,
		  172,   256,   278,   256,   256,   256,    22,  7500,    60,    80
	},
	.awb_ext_light_num = 0,
	.awb_ext_light_info = {
		0
...
struct isp_dynamic_param bf2257_mipi_2_isp_iso_settings = {
	.triger = {
		.sharp_triger = 1,
		.contrast_triger = 1,
		.denoise_triger = 1,
	...
	.isp_dynamic_cfg[0] = {
		.sharp_cfg = {
			0, 6, 350, 350, 400, 512, 256, 0, 256, 0, 8, 31, 20, 20, 20, 333, 4, 32, 11, 1, 1, 200, 256, 100, 100, 128, 128, 128, 128
		},
		.contrast_cfg = {
		...
		.color_denoise = 140,
		.ae_cfg = {
			700, 256, 600, 256, 31, 22, 22, 25, 3, 100, 2, 20, 4, 32
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[1] = {
		.sharp_cfg = {
			0, 8, 350, 350, 360, 440, 256, 0, 256, 0, 8, 31, 20, 20, 20, 333, 4, 32, 11, 1, 1, 200, 256, 200, 200, 128, 128, 128, 128
		},
		.contrast_cfg = {
			256, 256, 256, 256, 256, 256, 256, 256, 256, 256, 256
		},
		.denoise_cfg = {
			300, 0, 400, 0, 238, 255, 255, 64, 32, 32, 128, 48, 48, 32, 229, 97, 0, 0, 666, 666
		},
		.sensor_offset = {
		    -256, -256, -256, -256
		},
		...
		.color_denoise = 200,
		.ae_cfg = {
			700, 256, 600, 256, 30, 22, 22, 25, 3, 100, 2, 20, 4, 32
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 0, 4, 0, 0
		},
	...
	.isp_dynamic_cfg[2] = {
		.sharp_cfg = {
			1, 24, 350, 256, 256, 384, 256, 0, 256, 0, 8, 31, 20, 20, 20, 333, 4, 64, 11, 1, 1, 200, 256, 200, 200, 128, 128, 128, 128
		},
		.contrast_cfg = {
			256, 256, 256, 256, 256, 256, 256, 256, 256, 256, 256
		},
		.denoise_cfg = {
			300, 0, 400, 0, 240, 255, 255, 64, 32, 32, 128, 64, 64, 32, 229, 97, 0, 0, 666, 666
		},
		.sensor_offset = {
			 -256, -256, -256, -256
		},
		...
		.color_denoise = 240,
		.ae_cfg = {
			700, 256, 600, 256, 29, 22, 22, 25, 3, 100, 2, 20, 4, 32
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[3] = {
		.sharp_cfg = {
			3, 24, 350, 256, 256, 360, 256, 0, 256, 0, 8, 31, 20, 20, 20, 333, 3, 96, 11, 1, 1, 200, 256, 200, 200, 128, 128, 128, 128
		},
		.contrast_cfg = {
			256, 256, 256, 256, 256, 256, 256, 256, 256, 256, 256
		},
		...
		.color_denoise = 250,
		.ae_cfg = {
			700, 256, 600, 256, 28, 22, 22, 25, 3, 100, 2, 20, 4, 32
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 0, 6, 0, 0
		},
	...
	.isp_dynamic_cfg[4] = {
		.sharp_cfg = {
			4, 24, 350, 256, 256, 320, 256, 0, 256, 0, 8, 31, 0, 0, 0, 333, 5, 128, 11, 1, 1, 256, 256, 200, 200, 128, 128, 128, 128
		},
		.contrast_cfg = {
			256, 256, 256, 256, 256, 256, 256, 256, 256, 256, 256
		},
		...
		.color_denoise = 250,
		.ae_cfg = {
			700, 256, 600, 256, 27, 22, 22, 25, 3, 100, 2, 20, 4, 32
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 0, 6, 0, 0
		},
	...
	.isp_dynamic_cfg[5] = {
		...
		.color_denoise = 250,
		.ae_cfg = {
			512, 256, 512, 256, 25, 25, 25, 25, 3, 100, 4, 30, 2, 25
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[7] = {
		...
		.color_denoise = 250,
		.ae_cfg = {
			512, 256, 512, 256, 25, 22, 22, 25, 3, 90, 2, 20, 4, 32
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 0, 6, 0, 0
		},
	...
	.isp_dynamic_cfg[8] = {
		...
		.color_denoise = 1,
		.ae_cfg = {
			512, 256, 512, 256, 26, 22, 22, 25, 3, 90, 2, 20, 4, 32
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 0, 6, 0, 0
		},
	...
	.isp_dynamic_cfg[10] = {
		...
		.color_denoise = 1,
		.ae_cfg = {
			482, 512, 482, 512, 29, 29, 29, 29, 6, 90, 4, 30, 2, 25
		},
		.gtm_cfg = {
	...
	.isp_dynamic_cfg[11] = {
		...
		.color_denoise = 1,
		.ae_cfg = {
			482, 512, 482, 512, 29, 29, 29, 29, 6, 80, 4, 22, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 3, 1, 3, 0
		},
	...
	.isp_dynamic_cfg[12] = {
		...
		.color_denoise = 1,
		.ae_cfg = {
			482, 512, 482, 512, 29, 29, 29, 29, 6, 70, 4, 30, 2, 25
		},
		.gtm_cfg = {
			512, 2, 10, 10, 215, 3, 1, 3, 0
		},
...
struct isp_tunning_param bf2257_mipi_2_isp_tuning_settings = {
	.flash_gain = 80,
	...
	.color_matrix_ini[0] = {
		.matrix = { { 479, 0, -223 }, { -201, 540, -83 },
				{ -237, -533, 1026 } },
		.offset = { 0, 0, 0 }
	},
	.color_matrix_ini[1] = {
		.matrix = { { 502, -192, -54 }, { -107, 412, -49 },
				{ -61, -274, 591 } },
		.offset = { 0, 0, 0 }
	},
	.color_matrix_ini[2] = {
		.matrix = { { 546, -290, 0 }, { -85, 488, -147 },
				{ -26, -222, 504 } },
		.offset = { 0, 0, 0 }
	},
	.cm_trig_cfg = {
...
struct isp_cfg_pt bf2257_mipi_2_isp_cfg = {
	.isp_test_settings = &bf2257_mipi_2_isp_test_settings,
	.isp_3a_settings = &bf2257_mipi_2_isp_3a_settings,
	.isp_tunning_settings = &bf2257_mipi_2_isp_tuning_settings,
	.isp_iso_settings = &bf2257_mipi_2_isp_iso_settings
};


#endif /* end of _bf2257_MIPI_H_A100_ */
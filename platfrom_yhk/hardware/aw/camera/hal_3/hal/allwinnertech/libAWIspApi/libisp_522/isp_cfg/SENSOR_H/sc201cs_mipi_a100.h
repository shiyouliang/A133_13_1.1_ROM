 ...
 * Hawkview ISP - sc201cs_mipi config module
...
#ifndef _sc201cs_MIPI_DEFAULT_H_V459_
#define _sc201cs_MIPI_DEFAULT_H_V459_

#include "../../include/isp_ini_parse.h"

struct isp_test_param sc201cs_mipi_isp_test_settings = {
	.isp_test_mode = 0,
	.isp_test_exptime = 0,
	.exp_line_start = 160,
	.exp_line_step = 32,
...
struct isp_3a_param sc201cs_mipi_isp_3a_settings = {
	.define_ae_table = 1,
	.ae_max_lv = 1380,
	.ae_table_preview_length = 4,
	.ae_table_preview = {
		  8000,    1000,   256,   256,   266,   266,
		   1000,    1000,   256,   512,   266,   266,
		   1000,    500,   512,   512,   266,   266,
		   500,    500,   512,   2000,  266,   266
	},
	...
	.awb_light_num = 9,
	.awb_light_info = {
		  306,   256,   128,   256,   256,   256,    66,  1900,    99,    75,
		  294,   256,   131,   256,   256,   256,    66,  2300,    99,    82,
		  286,   256,   134,   256,   256,   256,    66,  2800,    99,    88,
		  231,   256,   148,   256,   256,   256,    66,  4000,    80,   100,
		  205,   256,   142,   256,   256,   256,    60,  4200,    60,   100,
		  183,   256,   174,   256,   256,   256,    60,  5300,    55,   100,
		  195,   256,   200,   256,   256,   256,    66,  5800,    33,   100,
		  182,   256,   227,   256,   256,   256,    66,  6500,    44,    80,
		  174,   256,   250,   256,   256,   256,    66,  7500,    33,    50
	},
	.awb_ext_light_num = 0,
	.awb_ext_light_info = {
		0
...
struct isp_dynamic_param sc201cs_mipi_isp_iso_settings = {
	.triger = {
		.sharp_triger = 1,
		.contrast_triger = 1,
		.denoise_triger = 1,
...
struct isp_tunning_param sc201cs_mipi_isp_tuning_settings = {
	.flash_gain = 80,
...
struct isp_cfg_pt sc201cs_mipi_isp_cfg = {
	.isp_test_settings = &sc201cs_mipi_isp_test_settings,
	.isp_3a_settings = &sc201cs_mipi_isp_3a_settings,
	.isp_tunning_settings = &sc201cs_mipi_isp_tuning_settings,
	.isp_iso_settings = &sc201cs_mipi_isp_iso_settings
};


#endif /* end of _sc201cs_MIPI_H_V100_ */
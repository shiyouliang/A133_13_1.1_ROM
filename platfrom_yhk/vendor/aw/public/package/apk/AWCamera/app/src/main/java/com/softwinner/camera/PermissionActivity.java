...
public class PermissionActivity extends Activity {
	...
	private boolean isStopActivity = false;//add by heml,for kill awcamera
...
//        System.loadLibrary("opencv_java3");
    ...
    protected void onStop() {
 		if(isStopActivity){
			PermissionLayoutManager.getInstance().finishCamera();
		}
		super.onStop();
    }
...
*/
    ...
    private void buildPermissionsRequest() {
		...
		isStopActivity=true;//add by heml,for kill awcamera
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        /*mSettingsManager.set(
                ...
                true);*/
		isStopActivity=false;//add by heml,for kill awcamera

...
import com.softwinner.camera.modes.ModeManager;
...
public class PaperFragment extends Fragment implements ModeViewPaper.OnEventListener {
    ...
    private void initTabLayoutPosition() {
        int topMargin = CameraData.getInstance().getScreenHeight() - CameraData.getInstance().getScreenHeight_4_TO_3() - getNavigationBarHeight();
        ...
        if (mTabLayout.getLayoutParams() instanceof FrameLayout.LayoutParams) {
            ...
            Log.d(TAG, "topMargin = " + topMargin + " textHeight = " + textHeight);
            tabLayoutLayoutParams.bottomMargin = topMargin - textHeight-getContext().getResources().getDimensionPixelOffset(R.dimen.text_bottom);

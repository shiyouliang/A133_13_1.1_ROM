...
import com.softwinner.camera.PermissionActivity;
import com.softwinner.camera.R;
import com.softwinner.camera.data.CameraData;
import com.softwinner.camera.data.Contants;
import com.softwinner.camera.utils.LocationUtils;
import com.softwinner.camera.utils.PlatFormsUtils;
...
public class AutoSettingFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
   ...
   // private SwitchPreference mManualExposure;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //mManualExposure = (SwitchPreference) findPreference(Contants.KEY_IS_OPEN_MANUAL_EXPOSURE);
        //mManualExposure.setOnPreferenceChangeListener(this);
    ...
    public void onResume() {
        ...
        String backValue = shp.getString(Contants.KEY_BACK_PICTURE_SCALE, Contants.PICTURE_SCALE_DEFAULT_VALUE_BACK);
        mBackListPreference.setSummary(backValue);
        String frontValue = shp.getString(Contants.KEY_FRONT_PICTURE_SCALE, Contants.PICTURE_SCALE_DEFAULT_VALUE_FRONT);

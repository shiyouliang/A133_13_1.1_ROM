...
package com.softwinner.xml.parse;
...
public class XmlPullParser extends Parser {
    ...
    public Node parse(org.xmlpull.v1.XmlPullParser xpp, InputStream inStream) throws ParserException {
        ...
        try {
            ...
            Log.e("XmlPullParser", "  eventType " + eventType);
            while (eventType != org.xmlpull.v1.XmlPullParser.END_DOCUMENT) {
                ...
                eventType = xpp.next();
                //Log.e("XmlPullParser", " yulh end eventType " + eventType);
            }
        } catch (Exception e) {
            throw new ParserException(e);
        }

        //Log.e("XmlPullParser", " yulh end rootNode " + rootNode.toString());
        return rootNode;
    }

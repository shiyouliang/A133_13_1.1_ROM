...
public class Node {
    ...
    public int getAttributeIntegerValue(String name) {
        ...
        try {
            if (Settings.ATTR_DURATION.equals(name) || Settings.ATTR_DELAY.equals(name)) {
                return Integer.parseInt(val) * 60 * 1000;//min to ms
            } else if (Settings.ATTR_OPEN_DURATION.equals(name) || Settings.ATTR_CLOSE_DURATION.equals(name)) {
                return Integer.parseInt(val) * 1000;//s to ms
            }

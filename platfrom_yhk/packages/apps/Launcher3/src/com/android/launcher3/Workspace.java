...
public class Workspace<T extends View & PageIndicator> extends PagedView<T>
    ...
    public void bindAndInitFirstWorkspaceScreen() {
        ...
        // Add the first page
        /// AW CODE: AWUI2.5 support search box remove
        // CellLayout firstPage = insertNewWorkspaceScreen(Workspace.FIRST_SCREEN_ID, getChildCount());
        CellLayout firstPage = mWorkspaceScreens.containsKey(Workspace.FIRST_SCREEN_ID)
                            ? mWorkspaceScreens.get(Workspace.FIRST_SCREEN_ID)
    ...
    /// AW CODE: AWUI2.5 support custom hotseat title
    @Override

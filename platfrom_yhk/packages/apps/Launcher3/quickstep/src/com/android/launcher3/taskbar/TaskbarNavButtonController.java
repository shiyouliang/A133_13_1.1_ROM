...
import android.os.SystemClock;//add by heml,for delay nav bar click
/**
...
public class TaskbarNavButtonController implements TaskbarControllers.LoggableTaskbarController {
	...
	private long lastHomeClickTime = 0;//add by heml,for delay home click
	private long lastBackClickTime = 0;//add by heml,for delay back click
    ...
    public void onButtonClick(@TaskbarButton int buttonType) {
        switch (buttonType) {
            case BUTTON_BACK:
                ...
                //add by heml,for delay back click
                if((SystemClock.elapsedRealtime() - lastBackClickTime) > 600){
            ...
            case BUTTON_HOME:
                ...
                //add by heml,for delay back click
                if((SystemClock.elapsedRealtime() - lastHomeClickTime) > 600){
                    lastHomeClickTime = SystemClock.elapsedRealtime();
                }else{
                    break;
                }
                //add by heml,for delay back click

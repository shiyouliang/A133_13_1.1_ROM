...
import com.android.launcher3.AllAppColorController;//add by heml,for AllApp NavBar and Statusbar color
/**
...
public class LauncherRecentsView extends RecentsView<BaseQuickstepLauncher, LauncherState>
    ...
    public void startHome() {
        mActivity.switchPeekyTabVisibility(true);
    ...
    public void onStateTransitionComplete(LauncherState finalState) {
        ...
        if(finalState==LauncherState.ALL_APPS){
            AllAppColorController.getInstance().setNavBarColor(true);
        }else if(finalState==LauncherState.NORMAL){
            AllAppColorController.getInstance().setNavBarColor(false);
        }else{
            AllAppColorController.getInstance().setNavBarColor(false);
        }
        //add by heml,for AllApp NavBar and Statusbar color

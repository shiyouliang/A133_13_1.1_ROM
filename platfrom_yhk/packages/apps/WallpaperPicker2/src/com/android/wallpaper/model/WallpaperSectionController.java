...
public class WallpaperSectionController implements
    ...
    /// AW CODE: [feat] setting live wallpaper does not work
    private WallpaperSectionView mWallpaperSectionView;
    /// AW: add end.
    ...
    public void onResume() {
        ...
        /// AW CODE: [feat] setting live wallpaper does not work
        mWallpaperSectionView.postDelayed(() -> {
            mHomePreviewCard.requestLayout();
            mLockscreenPreviewCard.requestLayout();
        }, 50);
        /// AW: add end.
    }
    ...
    public WallpaperSectionView createView(Context context) {
        ...
        /// AW CODE: [feat] setting live wallpaper does not work
        mWallpaperSectionView = wallpaperSectionView;
        /// AW: add end.
